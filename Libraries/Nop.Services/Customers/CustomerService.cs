...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public virtual Customer GetCustomerByUsername(string username)
        {
            ...
            if (null == customer && _customerSettings.EmailLoginEnabled)
            {
                customer = GetCustomerByEmail(username);
            }

            if (null == customer && _customerSettings.PhoneEnabled && _customerSettings.PhoneLoginEnabled)
            {
                customer = GetCustomerByPhone(username);
            }
